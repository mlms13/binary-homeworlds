...
import { createShip, createStar, createSystem, createPiece } from "../utils";
import {
  createSetupAction,
  createMoveAction,
  createCaptureAction,
...
import { Color, Size, Player } from "../types";
...
describe("Edge Cases and Error Conditions", () => {
  describe("Game Setup", () => {
    it("should start with correct initial state", () => {
      ...
      expect(state.bank.pieces.length).toBe(36); // 4 colors × 3 sizes × 3 pieces
