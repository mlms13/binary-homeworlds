...
export class ActionValidator {
  ...
  // Basic validation methods without turn/availability checks (for sacrifice followups)
  private static validateMoveActionBasic(
    action: MoveAction,
    gameState: GameState
  ): ActionValidationResult {
    const shipResult = findShip(gameState, action.shipId);
  ...
  private static validateCaptureActionBasic(
    action: CaptureAction,
    gameState: GameState
  ): ActionValidationResult {
    const system = findSystem(gameState, action.systemId);
  ...
  private static validateGrowActionBasic(
    action: GrowAction,
    gameState: GameState
  ): ActionValidationResult {
    const system = findSystem(gameState, action.systemId);
  ...
  private static validateTradeActionBasic(
    action: TradeAction,
    gameState: GameState
  ): ActionValidationResult {
    const system = findSystem(gameState, action.systemId);
